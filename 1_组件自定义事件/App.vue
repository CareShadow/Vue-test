	...
	<div class="todo-container">
		<div class="todo-wrap">
		  <MyHeader :addItem="addItem"/>
			<List :changeCheched="changeCheched" :todoList="todoList" :deleteOne="deleteOne"/>
			<MyFooter :screenItem="screenItem" :todoList="todoList" :appChangeAll="appChangeAll" :deleteItem="deleteItem"/>
		</div>
	</div>
	</div>
</template>
